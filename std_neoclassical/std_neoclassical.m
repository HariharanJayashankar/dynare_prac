...
M_.param_names = char(M_.param_names, 'ctau');
M_.param_names_tex = char(M_.param_names_tex, 'ctau');
M_.param_names_long = char(M_.param_names_long, 'ctau');
...
erase_compiled_function('std_neoclassical_static');
erase_compiled_function('std_neoclassical_dynamic');
M_.orig_eq_nbr = 4;
M_.eq_nbr = 4;
M_.ramsey_eq_nbr = 0;
...
var_list_ = char();
dynasave('simudata',var_list_);
save('std_neoclassical_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('std_neoclassical_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('std_neoclassical_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('std_neoclassical_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('std_neoclassical_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('std_neoclassical_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('std_neoclassical_results.mat', 'oo_recursive_', '-append');
end
